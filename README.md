# book-animal-inspection-admin-ui
...
```bash
cd book-animal-inspection-admin-ui
nvm use
```
...
```bash
docker build --target development --no-cache --tag book-animal-inspection-admin-ui:development .
```

Run:

```bash
docker run -p 3000:3000 book-animal-inspection-admin-ui:development
```
...
```bash
docker build --no-cache --tag book-animal-inspection-admin-ui .
```

Run:

```bash
docker run -p 3000:3000 book-animal-inspection-admin-ui
```
